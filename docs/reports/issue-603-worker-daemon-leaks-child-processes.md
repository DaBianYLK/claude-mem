...
4118969 1     161656   07:28:16  bun ~/.claude/plugins/cache/DaBianYLK/claude-mem/9.0.0/scripts/worker-service.cjs --daemon
```
...
- **Issue:** https://github.com/DaBianYLK/claude-mem/issues/603
- **Source Files:**
