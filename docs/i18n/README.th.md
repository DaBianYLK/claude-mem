...
Copyright (C) 2025 Alex Newman (@DaBianYLK) สงวนลิขสิทธิ์ทั้งหมด
...
- **เอกสาร**: [docs/](docs/)
- **ปัญหา**: [GitHub Issues](https://github.com/DaBianYLK/claude-mem/issues)
- **Repository**: [github.com/DaBianYLK/claude-mem](https://github.com/DaBianYLK/claude-mem)
- **ผู้เขียน**: Alex Newman ([@DaBianYLK](https://github.com/DaBianYLK))
