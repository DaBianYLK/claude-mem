...
זכויות יוצרים (C) 2025 Alex Newman (@DaBianYLK). כל הזכויות שמורות.
...
- **מאגר**: [github.com/DaBianYLK/claude-mem](https://github.com/DaBianYLK/claude-mem)
- **מחבר**: Alex Newman ([@DaBianYLK](https://github.com/DaBianYLK))
