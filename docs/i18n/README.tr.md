...
Telif Hakkı (C) 2025 Alex Newman (@DaBianYLK). Tüm hakları saklıdır.
...
- **Sorunlar**: [GitHub Issues](https://github.com/DaBianYLK/claude-mem/issues)
- **Depo**: [github.com/DaBianYLK/claude-mem](https://github.com/DaBianYLK/claude-mem)
- **Yazar**: Alex Newman ([@DaBianYLK](https://github.com/DaBianYLK))
