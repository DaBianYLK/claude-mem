...
Copyright (C) 2025 Alex Newman (@DaBianYLK). Minden jog fenntartva.
...
- **Hibák**: [GitHub Issues](https://github.com/DaBianYLK/claude-mem/issues)
- **Tároló**: [github.com/DaBianYLK/claude-mem](https://github.com/DaBianYLK/claude-mem)
- **Szerző**: Alex Newman ([@DaBianYLK](https://github.com/DaBianYLK))
