...
**Location:** `/Users/YOUR_USERNAME/.claude/plugins/marketplaces/DaBianYLK/plugin/scripts/mcp-server.cjs`
...
```json
{
  "mcpServers": {
    "mcp-search": {
      "command": "node",
      "args": [
        "/Users/YOUR_USERNAME/.claude/plugins/marketplaces/DaBianYLK/plugin/scripts/mcp-server.cjs"
      ]
    }
  }
}
