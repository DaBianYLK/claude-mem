...
1. Clear install cache:
   ```bash
   rm ~/.claude/plugins/marketplaces/DaBianYLK/.install-version
   ```
...
3. Check version marker:
   ```bash
   cat ~/.claude/plugins/marketplaces/DaBianYLK/.install-version
   cat ~/.claude/plugins/marketplaces/DaBianYLK/package.json | grep version
   ```
...
3. Check package.json exists:
   ```bash
   ls -la ~/.claude/plugins/marketplaces/DaBianYLK/package.json
   ```
...
3. Verify installation:
   ```bash
   ls -la ~/.claude/plugins/marketplaces/DaBianYLK/
   ```
...
2. **Create issue**: [GitHub Issues](https://github.com/DaBianYLK/claude-mem/issues)
